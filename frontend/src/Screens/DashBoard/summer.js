          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
            <div className="sm:max-w-lg">
              <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-6xl">
                Lowest Style With Best Quality
              </h1>
              <p className="mt-4 text-lg text-gray-600">
                Discover the latest trends with unbeatable quality and pricing.
              </p>
            </div>
            <div>
              <div className="mt-10">
                  ...
                  <div className="absolute transform sm:left-1/2 sm:top-0 sm:translate-x-8 lg:left-1/2 lg:top-1/2 lg:-translate-y-1/2 lg:translate-x-8">
                    <div className="flex items-center space-x-6 lg:space-x-8">
                      <div className="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                        <div className="h-64 w-44 overflow-hidden rounded-lg sm:opacity-0 lg:opacity-100 hover:scale-105 transform transition duration-300 shadow-lg">
                          <img
                            alt=""
                        ...
                        <div className="h-64 w-44 overflow-hidden rounded-lg hover:scale-105 transform transition duration-300 shadow-lg">
                          <img
                            alt=""
                ...
                <a
                  href="#"
                  className="mt-10 inline-block rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-center font-medium text-white shadow-lg transition-transform transform hover:-translate-y-1 hover:shadow-xl hover:bg-indigo-700"
                >
                  Shop Collection
                </a>
              </div>
